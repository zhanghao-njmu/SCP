    ...
    promises::future_promise(
      {
        ...
        aspect.ratio <- ifelse(is.null(group3), 5, 5 / max(length(unique(srt_tmp@meta.data[[group3]])), 1))
        # print(">>> plot:")
        # print(system.time(
        p3 <- SCP::CellStatPlot(
    ...
    promises::future_promise(
      {
        ...
        aspect.ratio <- ifelse(is.null(group4), 5, 5 / max(length(unique(srt_tmp@meta.data[[group4]])), 1))
        # print(">>> plot:")
        # print(system.time(
