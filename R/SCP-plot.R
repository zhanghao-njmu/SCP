...
#' ClassDimPlot(pancreas1k, group.by = "SubCellType", reduction = "UMAP", pt.size = 5, pt.alpha = 0.2, velocity = "stochastic")
...
DynamicHeatmap <- function(srt, lineages, feature_from = lineages,
                           ...
                           n_cluster = NULL, cluster_by = lineages, cluster_method = "kmeans", fuzzification = NULL, show_fuzzification = FALSE,
