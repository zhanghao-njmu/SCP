...
Or run `PrepareVirtualEnv(python = "/path/to/python")` to create a standalone python virtual environment for SCP using the specified python and install the necessary packages.
