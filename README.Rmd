...
Or run `PrepareVirtualEnv(python = "/path/to/python")` to create a standalone python virtual environment for SCP using the specified python.
...
Some network issues may cause the download to fail when installing packages, for example, you need to provide a github personal access token and restart rsession before downloading.
